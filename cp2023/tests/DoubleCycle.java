...
public final class DoubleCycle {
    ...
    private final static StorageSystem setupSystem() {
        ...
        ComponentId comp24 = new ComponentId(204);
        ...
        deviceCapacities.put(dev5, 1);
        deviceCapacities.put(dev6, 1);

        HashMap<ComponentId, DeviceId> initialComponentMapping = new HashMap<>(4);
        ...
        initialComponentMapping.put(comp5, dev5);
        initialComponentMapping.put(comp6, dev6);
        initialComponentMapping.put(comp24, dev4);
    ...
    private final static Collection<Thread> setupTransferers(StorageSystem system) {
        ...
        transferer.add(new Thread(new Runnable() {
            ...
            public void run() {
                ...
                executeTransfer(system, 106, 6, 5, 10);
        ...
        transferer.add(new Thread(new Runnable() {
            ...
            public void run() {
                sleep(300);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has started.");
                executeTransfer(system, 104, 4, 3, 20);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has finished.");
            }
        }));
        transferer.add(new Thread(new Runnable() {
            ...
            public void run() {
                sleep(400);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has started.");
                executeTransfer(system, 103, 3, 1, 10);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has finished.");
            }
        }));
        transferer.add(new Thread(new Runnable() {
            ...
            public void run() {
                sleep(500);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has started.");
                executeTransfer(system, 204, 4, 6, 10);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has finished.");
            }
        }));
        transferer.add(new Thread(new Runnable() {
            ...
            public void run() {
                sleep(600);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has started.");
                executeTransfer(system, 105, 5, 2, 10);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has finished.");
            }
        }));
        transferer.add(new Thread(new Runnable() {
            ...
            public void run() {
                sleep(700);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has started.");
                executeTransfer(system, 102, 2, 4, 10);
                System.out.println("Transferer " + Thread.currentThread().getId() + " has finished.");
            }
        }));
        return transferer;
    ...
    private final static CompTransfImpl executeTransfer(
            ...
            int dstDevId,
            long duration) {
        CompTransfImpl transfer = new CompTransfImpl(
